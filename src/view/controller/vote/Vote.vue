<script setup lang="ts">
    ...
    // import RecordVote from '@/api/RecordVote'
    ...
    const search = () => {
        // RecordVote.show(formSearch).then((res)=>{
        //     console.log(res)
        //     tableData.value = JSON.parse(JSON.stringify(res.data.data))
        // })
    }
