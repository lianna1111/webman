...
<template>
    ...
    <el-dialog v-model="dialogFormVisible" :title="form.id? '修改消息' : '新增消息'">
        <el-form size="large" :model="form" :label-width="formLabelWidth">
            ...
            <el-form-item label="消息内容">
                <el-col :span="16">
                    <el-input v-model="form.content" :rows="3" type="textarea" placeholder="消息内容" />
                </el-col>
            </el-form-item>
        </el-form>
        <template #footer>
