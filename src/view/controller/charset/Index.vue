<script setup lang="ts">
    ...
    const setShowData = async () => {
        Charset.show(search_data).then((res)=>{
            if(res.data.code === 0){
...
<template>
    ...
    <!-- action form -->
    <el-dialog v-model="dialogFormVisible" title="新增字符编码" width="700px">
        <el-form ref="ruleFormRef" :rules="rules" :model="form" size="large" :label-width="formLabelWidth">
            <el-form-item label="字符编码名称：">
                <el-col :span="14">
