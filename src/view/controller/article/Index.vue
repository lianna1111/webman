<script setup lang="ts">
    ...
    const search = () => {
        Article.show(formSearch).then((res)=>{
            console.log(res)
            tableData.value = JSON.parse(JSON.stringify(res.data.data))
        })
    }
